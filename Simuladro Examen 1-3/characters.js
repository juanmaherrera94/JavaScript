...
class StarWarsCharacters {
    ...
    avgMass() {
        ...
        characters.forEach(peso => {

            let pesoPersonaje = peso.mass;

            resultado += pesoPersonaje / characters.length;
        });
    ...
    getCharacterFilms(characterName) {
        let resultado = "";
        characters.forEach(caracter => {

            if (caracter.name === characterName) {

                resultado = caracter.films;
